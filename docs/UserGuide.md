...
The application is designed to work offline. Data is saved in the `data/`
directory under the application working/root directory and loaded when the app
starts. The file `data/budgetwise-data.ser` contains transactions, categories,
and budgets. Do not edit this file while BudgetWise is running.
